...
print(f"✅ Data rows used for Linear Regression: {len(data)}")
...
plt.title("Correlation Heatmap – Bat vs Rat Behaviour Variables")
plt.tight_layout()
...
print("\n📊 Linear Regression Summary (with Scaled Inputs):")
print(model.summary())
...
print("\n✅ Outputs saved: heatmap, model summary, evaluation metrics, and prediction plot.")
...
if len(sig_vars) > 0:
    print(f"\n✨ Optimizing model: keeping significant predictors {sig_vars}")
    ...
    print("\n⚠️ No predictors were statistically significant (p < 0.05). Model kept as is.")
